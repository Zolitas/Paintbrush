...
public class PaintBrushRecipeDataGenerator implements DataGeneratorEntrypoint {
    @Override
    public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
        FabricDataGenerator.Pack pack = fabricDataGenerator.createPack();
        pack.addProvider(PaintBrushRecipeProvider::new);
    }

    private static class PaintBrushRecipeProvider extends FabricRecipeProvider {
